...
function App() {
  ...
  return (
    <div className="App">
      ...
      <span onClick={clickspan1} className="logo">
        savvy
      </span>
      ...
      <img
        className="core"
        onClick={clickcore}
        src="https://blog.core.ac.uk/wp-content/themes/twentyfifteen-child/images/core_logo.png"
      />
      ...
      <div className="main">
        <Routes>
          ...
          <Route
            path="/veiwexisting"
            element={<VeiwExisting setThread={setThread} art={selArt} />}
          />
          <Route
            path="/signUp"
